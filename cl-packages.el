...
(dolist (sym
	  '(*MACROEXPAND-HOOK* ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF
	    ...
	    DO-SYMBOLS ELT FDEFINITION FIND-SYMBOL FIND-ALL-SYMBOLS
	    FIND-PACKAGE FLOAT FUNCTION FUNCTIONP GET-SETF-EXPANSION
	    ...
	    LOGORC2 LOGXOR MACRO-FUNCTION MACROEXPAND MACROEXPAND-1 MAKE-ARRAY
	    MAKE-LIST MAKE-PACKAGE MAPCAN MAPCAR MAX MIN MINUSP NUMBERP
	    PEEK-CHAR PRINT RANDOM READ-CHAR READ-LINE RPLACA RPLACD SETF
	    SIMPLE-BIT-VECTOR-P SIMPLE-VECTOR-P STRING STRINGP SUBTYPEP
	    SYMBOL-PACKAGE TYPEP UNREAD-CHAR UNUSE-PACKAGE
