...
(dolist (sym
	  '(*MACROEXPAND-HOOK* ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF
	    ...
	    ARRAY-HAS-FILL-POINTER-P ARRAYP ASH ATOM BACKQUOTE CAR CAAAAR
	    ...
	    CDDAAR CDDADR CDDAR CDDDAR CDDDDR CDDDR CDDR CDR COMMA COMMA-AT
	    COMMA-DOT COMPILED-FUNCTION-P COMPILER-MACRO-FUNCTION CONCATENATE
	    CONS CONSP COPY-SEQ COPY-STRUCTURE COPY-SYMBOL COPY-TREE
	    DEFINE-COMPILER-MACRO DEFINE-SETF-EXPANDER DEFMACRO DEFPACKAGE
	    DEFSETF DEFSTRUCT DEFUN DELETE-PACKAGE DO-SYMBOLS ELT FDEFINITION
	    FIND-SYMBOL FIND-ALL-SYMBOLS FIND-PACKAGE FLOAT FUNCTION FUNCTIONP
	    ...
	    LOGNOR LOGNOT LOGORC1 LOGORC2 LOGXOR MACRO-FUNCTION MACROEXPAND
	    MACROEXPAND-1 MAKE-ARRAY MAKE-LIST MAKE-PACKAGE MAPCAN MAPCAR MAX
	    MIN MINUSP NUMBERP PEEK-CHAR PRINT RANDOM READ-CHAR READ-LINE
	    RPLACA RPLACD SETF SIMPLE-BIT-VECTOR-P SIMPLE-VECTOR-P STRING
	    STRINGP SUBTYPEP SYMBOL-PACKAGE TYPEP UNREAD-CHAR UNUSE-PACKAGE
	    UPGRADED-ARRAY-ELEMENT-TYPE USE-PACKAGE UNINTERN VECTORP
	    WRITE-CHAR WRITE-LINE WRITE-STRING QUOTE ZEROP))
