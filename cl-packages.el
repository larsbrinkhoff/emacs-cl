...
(dolist (sym
	  '(ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF ARRAY-DIMENSION
	    ...
	    ARRAYP ASH ATOM BACKQUOTE CAR CDR COMMA COMMA-AT COMMA-DOT
	    COMPILED-FUNCTION-P CONCATENATE CONS CONSP COPY-SEQ COPY-STRUCTURE
	    COPY-SYMBOL DEFINE-SETF-EXPANDER DEFPACKAGE DEFSETF DEFSTRUCT DEFUN
