...
(dolist (sym
	  '(ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF ARRAY-DIMENSION
	    ...
	    COPY-SYMBOL DEFINE-SETF-EXPANDER DEFPACKAGE DEFSETF DEFSTRUCT
	    DELETE-PACKAGE DO-SYMBOLS ELT FIND-SYMBOL FIND-ALL-SYMBOLS
	    FIND-PACKAGE FLOAT FUNCTION GET-SETF-EXPANSION IN-PACKAGE INTEGERP
	    INTERN KEYWORDP LENGTH LIST-ALL-PACKAGES LOGAND LOGANDC1 LOGANDC2
