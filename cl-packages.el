...
(dolist (sym
	  '(*MACROEXPAND-HOOK* ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF
	    ARRAY-DIMENSION ARRAY-DIMENSIONS ARRAY-ELEMENT-TYPE
	    ARRAY-HAS-FILL-POINTER-P ARRAYP ASH ATOM BACKQUOTE BLOCK CAR CAAAAR
	    CAAADR CAAAR CAADAR CAADDR CAADR CAAR CADAAR CADADR CADAR CADDAR
	    CADDDR CADDR CADR CATCH CDAAAR CDAADR CDAAR CDADAR CDADDR CDADR
	    CDAR CDDAAR CDDADR CDDAR CDDDAR CDDDDR CDDDR CDDR CDR COMMA
	    COMMA-AT COMMA-DOT COMPILED-FUNCTION-P COMPILER-MACRO-FUNCTION
	    CONCATENATE CONS CONSP COPY-SEQ COPY-STRUCTURE COPY-SYMBOL
	    COPY-TREE DEFINE-COMPILER-MACRO DEFINE-SETF-EXPANDER
	    DEFINE-SYMBOL-MACRO DEFMACRO DEFPACKAGE DEFSETF DEFSTRUCT DEFUN
	    DELETE-PACKAGE DO-SYMBOLS ELT EVAL-WHEN FDEFINITION FIND-SYMBOL
	    FIND-ALL-SYMBOLS FIND-PACKAGE FLET FLOAT FUNCTION FUNCTIONP
	    GET-SETF-EXPANSION GO IF IN-PACKAGE INTEGERP INTERN KEYWORDP LABELS
	    LENGTH LET LET* LIST-ALL-PACKAGES LOAD-TIME-VALUE LOCALLY LOGAND
	    LOGANDC1 LOGANDC2 LOGEQV LOGIOR LOGNAND LOGNOR LOGNOT LOGORC1
	    LOGORC2 LOGXOR MACRO-FUNCTION MACROEXPAND MACROEXPAND-1 MACROLET
	    MAKE-ARRAY MAKE-LIST MAKE-PACKAGE MAPCAN MAPCAR MAX MIN MINUSP
	    MULTIPLE-VALUE-CALL MULTIPLE-VALUE-PROG1 NUMBERP PEEK-CHAR PRINT
	    PROGN PROGV QUOTE RANDOM READ-CHAR READ-LINE RETURN-FROM RPLACA
	    RPLACD SETF SETQ SIMPLE-BIT-VECTOR-P SIMPLE-VECTOR-P
	    SPECIAL-OPERATOR-P STRING STRINGP SUBTYPEP SYMBOL-MACROLET
	    SYMBOL-PACKAGE TAGBODY THE THROW TYPEP UNREAD-CHAR UNUSE-PACKAGE
	    UNWIND-PROTECT UPGRADED-ARRAY-ELEMENT-TYPE USE-PACKAGE UNINTERN
