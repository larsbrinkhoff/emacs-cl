...
(dolist (sym '(ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF ARRAY-DIMENSION
	       ...
	       ARRAYP ASH BACKQUOTE COMMA COMMA-AT COMMA-DOT COPY-SEQ ELT
	       FLOAT FUNCTION INTEGERP LENGTH LOGAND LOGANDC1 LOGANDC2 LOGEQV
	       LOGIOR LOGNAND LOGNOR LOGNOT LOGORC1 LOGORC2 LOGXOR MAKE-ARRAY
	       MAX MIN MINUSP NUMBERP PRINT RANDOM SETF SIMPLE-BIT-VECTOR-P
	       SIMPLE-VECTOR-P STRINGP SUBTYPEP TYPEP
