...
(dolist (sym
	  '(*GENSYM-COUNTER* *MACROEXPAND-HOOK* ADJUST-ARRAY ADJUSTABLE-ARRAY-P
	    ...
	    REALPART REMPROP RETURN-FROM RPLACA RPLACD SET SETF SETQ
	    SHORT-FLOAT SIMPLE-BIT-VECTOR SIMPLE-BIT-VECTOR-P SIMPLE-STRING
	    SIMPLE-STRING-P SIMPLE-VECTOR SIMPLE-VECTOR-P SINGLE-FLOAT
	    SIGNED-BYTE SPECIAL-OPERATOR-P STANDARD-CHAR STRING STRINGP
	    SUBTYPEP SYMBOL SYMBOL-FUNCTION SYMBOL-MACROLET SYMBOL-NAME
