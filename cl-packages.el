...
(dolist (sym
	  '(*MACROEXPAND-HOOK* ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF
	    ...
	    FUNCTIONP GET-SETF-EXPANSION GO IF IN-PACKAGE INTEGERP INTERN
	    KEYWORDP LABELS LENGTH LET LET* LIST-ALL-PACKAGES LOAD-TIME-VALUE
	    LOCALLY LOGAND LOGANDC1 LOGANDC2 LOGEQV LOGIOR LOGNAND LOGNOR
	    LOGNOT LOGORC1 LOGORC2 LOGXOR MACRO-FUNCTION MACROEXPAND
	    MACROEXPAND-1 MACROLET MAKE-ARRAY MAKE-LIST MAKE-PACKAGE MAPCAN
	    MAPCAR MAX MIN MINUSP MULTIPLE-VALUE-CALL MULTIPLE-VALUE-PROG1 NIL
	    NOT NUMBERP PEEK-CHAR PRINT PROGN PROGV QUOTE RANDOM READ-CHAR
	    READ-LINE RETURN-FROM RPLACA RPLACD SETF SETQ SIMPLE-BIT-VECTOR-P
	    SIMPLE-VECTOR-P SPECIAL-OPERATOR-P STRING STRINGP SUBTYPEP
	    SYMBOL-MACROLET SYMBOL-PACKAGE T TAGBODY THE THROW TYPEP
	    UNREAD-CHAR UNUSE-PACKAGE UNWIND-PROTECT
	    UPGRADED-ARRAY-ELEMENT-TYPE USE-PACKAGE UNINTERN VECTORP
