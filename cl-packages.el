...
(dolist (sym
	  '(ADJUST-ARRAY ADJUSTABLE-ARRAY-P AREF ARRAY-DIMENSION
	    ...
	    ARRAYP ASH ATOM BACKQUOTE CAR CAAAAR CAAADR CAAAR CAADAR CAADDR
	    CAADR CAAR CADAAR CADADR CADAR CADDAR CADDDR CADDR CADR CDAAAR
	    CDAADR CDAAR CDADAR CDADDR CDADR CDAR CDDAAR CDDADR CDDAR CDDDAR
	    CDDDDR CDDDR CDDR CDR COMMA COMMA-AT COMMA-DOT COMPILED-FUNCTION-P
	    CONCATENATE CONS CONSP COPY-SEQ COPY-STRUCTURE COPY-SYMBOL
	    DEFINE-SETF-EXPANDER DEFPACKAGE DEFSETF DEFSTRUCT DEFUN
	    DELETE-PACKAGE DO-SYMBOLS ELT FDEFINITION FIND-SYMBOL
	    FIND-ALL-SYMBOLS FIND-PACKAGE FLOAT FUNCTION FUNCTIONP
	    ...
	    LOGNOR LOGNOT LOGORC1 LOGORC2 LOGXOR MAKE-ARRAY MAKE-LIST
	    MAKE-PACKAGE MAPCAN MAPCAR MAX MIN MINUSP NUMBERP PEEK-CHAR PRINT
	    RANDOM READ-CHAR READ-LINE RPLACA RPLACD SETF SIMPLE-BIT-VECTOR-P
