...
NSTRING-UPCASE NSUBLIS NSUBST NSUBST-IF NSUBST-IF-NOT NSUBSTITUTE-IF-NOT NTH
NTH-VALUE NTHCDR NULL NUMBER NUMBERP NUMERATOR NUNION ODDP OPEN OPTIMIZE OR
...
PEEK-CHAR PHASE PI PLUSP POP POSITION POSITION-IF POSITION-IF-NOT PRIN1 PRINC
PRINT PRINT-NOT-READABLE PRINT-NOT-READABLE-OBJECT PRINT-UNREADABLE-OBJECT
PROBE-FILE PROCLAIM PROG PROG* PROG1 PROG2 PROGN PROGRAM-ERROR PROVIDE PSETF
PSETQ PROGV PUSH PUSHNEW QUOTE RANDOM RANDOM-STATE RANDOM-STATE-P RASSOC
RASSOC-IF RASSOC-IF-NOT RATIO RATIONAL RATIONALIZE RATIONALP READ READ-CHAR
...
REAL REALP REALPART REM REMF REMHASH REMOVE-IF-NOT REMPROP RENAME-FILE
...
SUBST-IF SUBST-IF-NOT SUBSTITUTE-IF-NOT SUBTYPEP SVREF SYMBOL SYMBOL-FUNCTION
...
UNDEFINED-FUNCTION UNEXPORT UNINTERN UNION UNLESS UNREAD-CHAR UNSIGNED-BYTE
UNTRACE UNUSE-PACKAGE UNWIND-PROTECT UPGRADED-ARRAY-ELEMENT-TYPE
