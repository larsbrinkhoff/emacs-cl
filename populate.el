...
DEFSETF DEFSTRUCT DEFTYPE DEFUN DEFVAR DELETE-PACKAGE DENOMINATOR DEPOSIT-FIELD
DIGIT-CHAR-P DISASSEMBLE DO DO* DO-SYMBOLS DO-ALL-SYMBOLS DO-EXTERNAL-SYMBOLS
DOLIST DOTIMES DOUBLE-FLOAT DPB DYNAMIC-EXTENT ECASE EIGHTH ELT EQ EQL EQUAL
...
PAIRLIS PARSE-INTEGER PEEK-CHAR PHASE POP PRIN1 PRINC PRINT PROCLAIM PROG1
PROG2 PROGN PSETQ PROGV PUSH PUSHNEW QUOTE RANDOM RASSOC RASSOC-IF
...
READTABLEP REAL REALP REALPART REMHASH REMPROP REST RETURN RETURN-FROM ROOM
...
SEVENTH SHADOW SHORT-FLOAT SHORT-SITE-NAME SIMPLE-BIT-VECTOR
SIMPLE-BIT-VECTOR-P SIMPLE-STRING SIMPLE-STRING-P SIMPLE-VECTOR SIMPLE-VECTOR-P
SIN SINGLE-FLOAT SIGNED-BYTE SIGNUM SIXTH SLEEP SOFTWARE-TYPE SOFTWARE-VERSION
SOME SORT SPECIAL SPECIAL-OPERATOR-P SQRT STANDARD-CHAR STRING/= STRING<
...
TRUNCATE TYPE TYPE-OF TYPECASE TYPEP UNLESS UNREAD-CHAR UNSIGNED-BYTE
