...
CHAR>= CHARACTER CHARACTERP CHECK-TYPE CIS CLEAR-INPUT CLEAR-OUTPUT CLOSE
CLRHASH CODE-CHAR COERCE COMPILATION-SPEED COMPILE-FILE-PATHNAME
...
CTYPECASE DEBUG DECF DECLAIM DECLARATION DECLARE DECODE-FLOAT
DECODE-UNIVERSAL-TIME DEFCONSTANT DEFINE-COMPILER-MACRO DEFINE-CONDITION
...
FIND-IF-NOT FIND-ALL-SYMBOLS FIND-PACKAGE FIND-RESTART FIND-SYMBOL
...
STRUCTURE STYLE-WARNING SUBLIS SUBSEQ SUBSETP SUBST SUBST-IF SUBST-IF-NOT
SUBSTITUTE SUBSTITUTE-IF SUBSTITUTE-IF-NOT SUBTYPEP SVREF SYMBOL
