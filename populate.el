...
MAKE-PACKAGE MAKE-SEQUENCE MAKE-STRING MAKE-SYMBOL MAKE-STRING-INPUT-STREAM
MAKE-STRING-OUTPUT-STREAM MAKE-TWO-WAY-STREAM MAKUNBOUND MAP MAP-INTO MAPC
MAPCAN MAPCAR MAPCON MAPHASH MAPL MAPLIST MASK-FIELD MAX MEMBER MEMBER-IF
MEMBER-IF-NOT MIN MINUSP MOD MOST-NEGATIVE-DOUBLE-FLOAT MOST-NEGATIVE-FIXNUM
...
TAGBODY TAILP TAN TENTH TERPRI THE THIRD THROW TIME TREE-EQUAL TRUENAME
TRUNCATE TWO-WAY-STREAM-INPUT-STREAM TWO-WAY-STREAM-OUTPUT-STREAM TYPE
