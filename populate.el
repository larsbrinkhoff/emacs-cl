...
COMPILATION-SPEED COMPILE-FILE-PATHNAME COMPILED-FUNCTION COMPILED-FUNCTION-P
COMPILER-MACRO COMPILER-MACRO-FUNCTION COMPLEMENT COMPLEX COMPLEXP
COMPUTE-RESTARTS CONCATENATE COND CONDITION CONJUGATE CONS CONSP CONSTANTLY
CONSTANTP CONTINUE CONTROL-ERROR COPY-ALIST COPY-LIST COPY-READTABLE COPY-SEQ
COPY-STRUCTURE COPY-SYMBOL COPY-TREE COS COSH CTYPECASE DEBUG DECF DECLAIM
DECLARATION DECLARE DECODE-FLOAT DECODE-UNIVERSAL-TIME DEFCONSTANT
DEFINE-COMPILER-MACRO DEFINE-CONDITION DEFINE-MODIFY-MACRO DEFINE-SETF-EXPANDER
DEFINE-SYMBOL-MACRO DEFMACRO DEFPACKAGE DEFPARAMETER DEFSETF DEFSTRUCT DEFTYPE
DEFUN DEFVAR DELETE DELETE-DUPLICATES DELETE-FILE DELETE-IF DELETE-IF-NOT
...
WITH-STANDARD-IO-SYNTAX WRITE WRITE-CHAR WRITE-LINE WRITE-STRING
WRITE-TO-STRING ZEROP))
