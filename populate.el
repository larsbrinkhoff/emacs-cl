...
CHAR= CHAR> CHAR>= CHARACTER CHARACTERP CHECK-TYPE CIS CLOSE CLRHASH CODE-CHAR
COERCE COMPILED-FUNCTION COMPILED-FUNCTION-P COMPILER-MACRO
...
COPY-SYMBOL COPY-TREE COS COSH DECF DECLAIM DECLARATION DECLARE DECODE-FLOAT
...
DIGIT-CHAR-P DIRECTORY DISASSEMBLE DIVISION-BY-ZERO DO DO* DO-SYMBOLS
...
REAL REALP REALPART REM REMHASH REMPROP RENAME-FILE RENAME-PACKAGE REQUIRE REST
RESTART RESTART-BIND RESTART-NAME RETURN RETURN-FROM REVAPPEND ROOM ROTATEF
ROUND ROW-MAJOR-AREF RPLACA RPLACD SATISFIES SBIT SCALE-FLOAT SCHAR SECOND
