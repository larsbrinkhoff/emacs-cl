...
CHECK-TYPE CLOSE CODE-CHAR COERCE COMPILED-FUNCTION COMPILED-FUNCTION-P
...
GETF GO HASH-TABLE IDENTITY IF IMAGPART IMPORT IN-PACKAGE INCF INTEGER
...
NCONC NINTH NOT NRECONC NSTRING-DOWNCASE NSTRING-UPCASE NSUBLIS NSUBST
NSUBST-IF NSUBST-IF-NOT NTH NTH-VALUE NULL NUMBER NUMBERP NUMERATOR OPEN OR
...
PHASE PRIN1 PRINC PRINT PROGN PROGV QUOTE RANDOM RASSOC RASSOC-IF RASSOC-IF-NOT
...
REALP REALPART REMPROP RETURN-FROM ROW-MAJOR-AREF RPLACA RPLACD SBIT SCHAR
...
WRITE-STRING WRITE-TO-STRING Y-OR-N-P YES-OR-NO-P ZEROP))
	...
	(when found
	  (UNINTERN symbol *common-lisp-package*)
