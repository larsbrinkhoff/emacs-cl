...
CHAR= CHARACTER CHARACTERP CHECK-TYPE CLOSE CODE-CHAR COERCE COMPILED-FUNCTION
...
FIFTH DOUBLE-FLOAT DPB ELT EQ EQL EQUAL EVAL-WHEN EXTENDED-CHAR EIGHTH EXPORT
FDEFINITION FILE-POSITION FILL-POINTER FIND-ALL-SYMBOLS FIND-PACKAGE
FIND-SYMBOL FIRST FIXNUM FLET FLOAT FOURTH FUNCALL FUNCTION FUNCTIONP GENSYM
GENTEMP GET GET-DISPATCH-MACRO-CHARACTER GET-MACRO-CHARACTER GET-SETF-EXPANSION
GET-OUTPUT-STREAM-STRING GET-PROPERTIES GETF GO HASH-TABLE IDENTITY IF IMAGPART
IMPORT IN-PACKAGE INTEGER INTEGER-LENGTH INTEGERP INTERN KEYWORD KEYWORDP
LABELS LAST LDB LDB-TEST LENGTH LET LET* LISP-IMPLEMENTATION-TYPE
...
MACRO-FUNCTION MACROEXPAND MACROEXPAND-1 MACROLET MAKE-ARRAY MAKE-LIST
MAKE-PACKAGE MAKE-SYMBOL MAKE-STRING MAKE-STRING-INPUT-STREAM
MAKE-STRING-OUTPUT-STREAM MAKUNBOUND MAP MAPCAN MAPCAR MASK-FIELD MAX MEMBER
MIN MINUSP MOD MOST-NEGATIVE-FIXNUM MOST-POSITIVE-FIXNUM MULTIPLE-VALUE-CALL
MULTIPLE-VALUE-PROG1 NAME-CHAR NBUTLAST NCONC NINTH NOT NRECONC NSUBLIS NSUBST
...
PACKAGE-USED-BY-LIST PACKAGEP PAIRLIS PARSE-INTEGER PEEK-CHAR PHASE PRIN1 PRINT
PROGN PROGV QUOTE RANDOM RASSOC RASSOC-IF RASSOC-IF-NOT RATIO RATIONAL
...
REALPART REMPROP RETURN-FROM ROW-MAJOR-AREF RPLACA RPLACD SBIT SCHAR SECOND SET
...
UPPER-CASE-P USE-PACKAGE UNINTERN VALUES VECTOR VECTOR-POP VECTOR-PUSH
VECTOR-PUSH-EXTEND VECTORP WITH-INPUT-FROM-STRING WITH-OPEN-FILE
...
WRITE-STRING WRITE-TO-STRING Y-OR-N-P YES-OR-NO-P ZEROP))
	...
	(when found
	  (IMPORT (list symbol) *common-lisp-package*)
	  (EXPORT (list symbol) *common-lisp-package*))))))
