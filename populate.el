...
MAP-INTO MAPC MAPCAN MAPCAR MAPHASH MASK-FIELD MAX MEMBER MIN MINUSP MOD
...
MULTIPLE-VALUE-SETQ NAME-CHAR NBUTLAST NCONC NINTH NOT NRECONC NSTRING-DOWNCASE
NSTRING-UPCASE NSUBLIS NSUBST NSUBST-IF NSUBST-IF-NOT NTH NTH-VALUE NULL NUMBER
NUMBERP NUMERATOR ODDP OPEN OR PACKAGE PACKAGE-NAME PACKAGE-NICKNAMES
PACKAGE-SHADOWING-SYMBOLS PACKAGE-USE-LIST PACKAGE-USED-BY-LIST PACKAGEP
PAIRLIS PARSE-INTEGER PEEK-CHAR PHASE PRIN1 PRINC PRINT PROGN PROGV QUOTE
...
RETURN-FROM ROW-MAJOR-AREF RPLACA RPLACD SBIT SCHAR SECOND SET
...
TAGBODY TAN TENTH TERPRI THE THIRD THROW TREE-EQUAL TRUNCATE TYPE-OF TYPEP
