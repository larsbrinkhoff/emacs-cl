...
LOGEQV LOGIOR LOGNAND LOGNOR LOGNOT LOGORC1 LOGORC2 LOGTEST LOGXOR LONG-FLOAT
...
MULTIPLE-VALUE-SETQ MULTIPLE-VALUES-LIMIT NAME-CHAR NBUTLAST NCONC NINTH NOT
...
NUMERATOR ODDP OPEN OPTIMIZE OR OTHERWISE OUTPUT-STREAM-P PACKAGE PACKAGE-ERROR
...
SIMPLE-CONDITION-FORMAT-ARGUMENTS SIMPLE-CONDITION-FORMAT-CONTROL SIMPLE-ERROR
...
SLEEP SOFTWARE-TYPE SOFTWARE-VERSION SOME SORT SPECIAL SPECIAL-OPERATOR-P SQRT
...
STYLE-WARNING SUBLIS SUBSEQ SUBST SUBST-IF SUBST-IF-NOT SUBTYPEP SVREF SYMBOL
...
UNDEFINED-FUNCTION UNEXPORT UNLESS UNREAD-CHAR UNSIGNED-BYTE UNUSE-PACKAGE
UNWIND-PROTECT UPGRADED-ARRAY-ELEMENT-TYPE UPGRADED-COMPLEX-PART-TYPE
UPPER-CASE-P USE-PACKAGE USE-VALUE UNINTERN VALUES VALUES-LIST VECTOR
