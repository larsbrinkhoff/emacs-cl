...
EIGHTH ELT ENSURE-DIRECTORIES-EXIST EQ EQL EQUAL ETYPECASE EVAL-WHEN EVENP EVER
EXP EXPORT EXPT EXTENDED-CHAR FBOUNDP FCEILING FDEFINITION FFLOOR FIFTH
FILE-AUTHOR FILE-POSITION FILE-WRITE-DATE FILL-POINTER FIND-ALL-SYMBOLS
...
GET-OUTPUT-STREAM-STRING GET-PROPERTIES GETF GETHASH GO HASH-TABLE
...
SINGLE-FLOAT-NEGATIVE-EPSILON SIGNED-BYTE SIGNUM SIXTH SLEEP SOFTWARE-TYPE
SOFTWARE-VERSION SOME SORT SPECIAL SPECIAL-OPERATOR-P SQRT STANDARD-CHAR
...
STRING-UPCASE STRINGP SUBLIS SUBST SUBST-IF SUBST-IF-NOT SUBTYPEP SVREF SYMBOL
...
TRUENAME TRUNCATE TYPE TYPE-OF TYPECASE TYPEP UNLESS UNREAD-CHAR UNSIGNED-BYTE
