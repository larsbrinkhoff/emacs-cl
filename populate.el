...
DELETE-FILE DELETE-IF-NOT DELETE-PACKAGE DENOMINATOR DEPOSIT-FIELD DIGIT-CHAR
DIGIT-CHAR-P DIRECTORY DIRECTORY-NAMESTRING DISASSEMBLE DIVISION-BY-ZERO DO DO*
...
NSUBSTITUTE NSUBSTITUTE-IF NSUBSTITUTE-IF-NOT NTH NTH-VALUE NTHCDR NULL NUMBER
NUMBERP NUMERATOR NUNION ODDP OPEN OPTIMIZE OR OTHERWISE OUTPUT-STREAM-P
...
POSITION-IF-NOT PRIN1 PRINC PRINT PRINT-NOT-READABLE PRINT-NOT-READABLE-OBJECT
...
READTABLEP REAL REALP REALPART REM REMF REMHASH REMOVE-IF-NOT REMPROP
RENAME-FILE RENAME-PACKAGE REQUIRE REST RESTART RESTART-BIND RESTART-NAME
RETURN RETURN-FROM REVAPPEND REVERSE ROOM ROTATEF ROUND ROW-MAJOR-AREF RPLACA
...
SET-EXCLUSIVE-OR SET-MACRO-CHARACTER SET-SYNTAX-FROM-CHAR SETF SETQ SEVENTH
SHADOW SHADOWING-IMPORT SHIFTF SHORT-FLOAT SHORT-FLOAT-EPSILON
...
SUBST-IF SUBST-IF-NOT SUBSTITUTE SUBSTITUTE-IF SUBSTITUTE-IF-NOT SUBTYPEP SVREF
SYMBOL SYMBOL-FUNCTION SYMBOL-MACROLET SYMBOL-NAME SYMBOL-PACKAGE SYMBOL-PLIST
SYMBOL-VALUE SYMBOLP T TAGBODY TAILP TAN TANH TENTH TERPRI THE THIRD THROW TIME
TRACE TRANSLATE-PATHNAME TREE-EQUAL TRUENAME TRUNCATE
